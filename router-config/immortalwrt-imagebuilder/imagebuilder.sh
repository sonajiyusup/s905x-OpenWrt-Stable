...
#
# Description: Build immortalwrt with Image Builder
# Copyright (C) 2021- https://github.com/unifreq/openwrt_packit
# Copyright (C) 2021- https://github.com/ophub/amlogic-s9xxx-openwrt
#
# Download from: https://downloads.immortalwrt.org/releases/
# Documentation: https://openwrt.org/docs/guide-user/additional-software/imagebuilder
# Instructions:  Download immortalwrt firmware from the official OpenWrt,
...
# download_imagebuilder   : Downloading immortalwrt ImageBuilder
...
custom_files_path="${make_path}/router-config/immortalwrt-imagebuilder/files"
custom_config_file="${make_path}/router-config/immortalwrt-imagebuilder/config"
...
download_imagebuilder() {
    ...
    # Download example: https://downloads.immortalwrt.org/releases/21.02.3/targets/armvirt/64/immortalwrt-imagebuilder-21.02.3-armvirt-64.Linux-x86_64.tar.xz
